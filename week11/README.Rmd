...
- Use `plot_ly()` to create a heatmap out of this matrix. Which states stand out? *States that have large populations or with large outbreaks stand out (California, Florida, Texas)*
- Repeat with `newper100k` variable. Now which states stand out? *Now, there are more states standing out; for example, Alaska had a high case rate, as well as some southern states (Mississippi, Louisiana, South Carolina).*
...
### Plot together 
subplot(fig_pick.date, fig_Today, titleX = "Cases per 100k per State as of October 15th, 2021",titleY = "Cases per 100k per State as of November 11th, 2021",nrows = 2, margin = .05)
